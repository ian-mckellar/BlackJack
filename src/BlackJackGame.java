...
public class BlackJackGame extends JPanel {
	...
	public void handPlay() {
		...
		if (bust) {
			JOptionPane.showMessageDialog(this, "Bust! Dealer wins.\nYou lost $"+bet, "Bust",
			...
			JOptionPane.showMessageDialog(
					...
					"You won the hand!\nYour card value"
							...
							+ "\nDealer card value: "
							+ players[1].getPlayersHandTotal()+"\nYou won $"+bet*1.5, "Hand won",
					JOptionPane.OK_OPTION);
			money += bet * 2;
